...
export const portfolioData: PortfolioItem[] = [
  ...
  },
  {
    ...
    description: "Delivered 9×16 promotional assets for Instagram and social platforms around the Fortnite × Travis Scott \"Astronomical\" event, adapting end-cards into multiple languages to support the synchronized global launch. The live shows drew 12.3 million concurrent players and over 27 million unique participants across all dates, making it one of the largest virtual concert events of its kind.",
